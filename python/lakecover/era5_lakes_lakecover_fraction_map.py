...
directory = '/Users/Luke/Documents/PHD/C3S_511/DATA/lakecover'
os.chdir(directory)
file = 'lakemask.nc'
o_directory = '/Users/Luke/Documents/PHD/C3S_511/FIGURES/lakecover'
...
lon = cover.lon.values
lat = cover.lat.values
...
#save figure
f.savefig(o_directory+'/'+'era5_lakes_lakecover_0_1_map.png',bbox_inches='tight',dpi=500)
