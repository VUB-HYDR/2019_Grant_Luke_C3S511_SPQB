...
cmap = mpl.colors.ListedColormap([cmap_50,cmap_40,cmap_30,cmap_20,cmap0,
                                  cmap20,cmap30,cmap40,cmap50],N=9)
...
cb.ax.set_xticklabels([r'$\leq$-1.0','-0.75','-0.50',\
                       '-0.25','0','0.25','0.5','0.75',r'1.0$\leq$'])
