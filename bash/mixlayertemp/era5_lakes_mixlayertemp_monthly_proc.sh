...
# mask starting file
cdo -b F64 ifthen $maskDIR/lakemask.nc era5_lakes_mixlayertemp_monthly_1979_2019.nc $scratchDIR/startfile.nc
...
for SEASON in "${SEASONs[@]}"; do
    ...
    cdo -b F64 -O -L timmean -seldate,1979-01-01T00:00:00,1983-12-31T00:00:00 $scratchDIR/mixlayertemp_${SEASON}_1979_2019.nc $scratchDIR/mixlayertemp_${SEASON}_5year_start.nc

    # signal for seasonal average maps (last 5 years)
    cdo -b F64 -O -L timmean -seldate,2014-01-01T00:00:00,2018-12-31T00:00:00 $scratchDIR/mixlayertemp_${SEASON}_1979_2019.nc $scratchDIR/mixlayertemp_${SEASON}_5year_end.nc

    #signal for seasonal average maps (diff)
    cdo -b F64 -O -L sub $scratchDIR/mixlayertemp_${SEASON}_5year_end.nc $scratchDIR/mixlayertemp_${SEASON}_5year_start.nc $outDIR/era5_lakes_mixlayertemp_${SEASON}_signal_1979_2019.nc

    # remove temporary files per season
    rm $scratchDIR/mixlayertemp_${SEASON}_1979_2019.nc
    rm $scratchDIR/mixlayertemp_${SEASON}_5year_end.nc
    rm $scratchDIR/mixlayertemp_${SEASON}_5year_start.nc
